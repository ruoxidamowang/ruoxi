...
<!-- 3.网上书城用户注册  start -->
	<div id="divcontent">
		<form action="${pageContext.request.contextPath }/registerAction" method="post" onsubmit="return checkForm();">
					...
					<td style="padding: 30px"><h1>新用户注册</h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<td><input type="text" class="textinput"  id="username" name="username" onkeyup="checkUsername();"/><br><font color="#ff0000">&nbsp;&nbsp;&nbsp;${requestScope.registerFailmessage }</font>
								</td>
