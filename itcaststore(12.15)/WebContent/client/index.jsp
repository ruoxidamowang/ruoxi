<%@ page language="java" import="java.util.*" pageEncoding="UTF-8" import="com.entity.*,com.service.*"%>
			...
			<tr>
				<td width="497">
					...
					<%
						...
						Notice news=noticeService.showNewNotice();
						request.setAttribute("news", news); 
					%>
					<table cellspacing="0" class="ctl">
						<tr>
							<td width="485" height="100%">${news.details }</td>
						</tr>
					</table>
				</td>
