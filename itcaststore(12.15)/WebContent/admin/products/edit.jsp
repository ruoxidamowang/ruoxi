...
<body onload="setProductCategory('${productslist.category}')">
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/editProductsAction" method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="name" class="bg" value="${productslist.name }" />
				</td>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品价格：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="price" class="bg" value="${productslist.price }" />
				</td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品数量：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="pnum" class="bg" value="${productslist.pnum }" />
				</td>
			...
			<tr>
				...
				<input type="file" name="upload" size="30" value="${productslist.imgurl }" /></td>
			</tr>
			<TR>
				<TD class="ta_01" align="center" bgColor="#f5fafe">商品描述：</TD>
				<TD class="ta_01" bgColor="#ffffff" colSpan="3">
					<textarea name="description" cols="30" rows="3" style="WIDTH: 96%">${productslist.description }</textarea>
				</TD>
			</TR>
			<TR>
