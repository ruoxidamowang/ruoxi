...
<body>
	<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/addProductsAction" method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text" name="name" class="bg" /></td><font color="#ff0000">&nbsp;&nbsp;&nbsp;${requestScope.addFailmessage }</font>
