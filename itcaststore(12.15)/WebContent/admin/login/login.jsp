								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/admin/images/loginbg.gif">
											<form id="loginAction_home" name="form1" action="${pageContext.request.contextPath}/adminLoginAction" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<font color="#ff0000">&nbsp;&nbsp;&nbsp;${requestScope.loginFailmessage }</font>
														<td>
															<input type="text" name="loginName" value="" id="loginName" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
														...
														<td>
															<input type="password" name="loginPwd" id="loginPwd" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
