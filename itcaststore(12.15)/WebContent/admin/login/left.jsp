...
<head>
	...
	<body>
		...
		<table width="100%" border="0">
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/adminFindProducts" target="mainFrame" class="left_list">商品管理</a></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/showAllNoticeAction" target="mainFrame" class="left_list">公告管理</a></td>
			  </tr>
		</table>
	</body>
</html>
